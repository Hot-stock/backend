...
import com.bjcareer.gateway.security.repository.RedisRepository;
...
public class RoleAspect {
    ...
    public void checkRole(HasRole hasRole, HttpServletRequest request) {
        ...
        List<RoleType> roleType =  authTokenBySessionId.get().getRoleType();


        boolean hasRequiredRole = roleType.stream()
