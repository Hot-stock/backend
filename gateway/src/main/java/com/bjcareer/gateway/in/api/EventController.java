...
public class EventController {
	...
	public ResponseEntity<ResponseDomain<NextStockEventNewsDTO>> findNextScheduleOfStock(
		@RequestParam(name = "q") String keyword) {
		log.info("Request: {}", keyword);

		ResponseDomain<NextStockEventNewsDTO> nextScheduleOfStock = searchServerPort.getNextEventNewsFilterByStockName(
			keyword);
		return new ResponseEntity<>(nextScheduleOfStock, nextScheduleOfStock.getStatusCode());
	}
