...
public class AnalyzeThemaNamePrompt {
	public static final String PROMPT =
			...
			+ "질문: reason 필드의 상승 이유를 한 단어로 요약할 수 있는 테마 이름을 알고싶어.\n"

			+ "가이드라인\n"

			+ "1. **주식 상승의 1차원인을 획득"
			+ " 주식 상승의 1차 원인을 확인하고, 인물, 제품, 사건의 명칭을 획득합니다. 주의할 점은 반듯이 기사에서 언급한 사실만을 사용합니다.\n"
			...
			+ "2. 획득한 명칭의 단어만으로 해당 주제에 관련된 사실들을 크롤링할 수 있도록 테마를 명확화합니다.\n"
		...
		+ "<themas> </themas>에는 이전부터 사용한 테마 내역들이 있고 ','로 구분되어 있어.\n"
			+ "가이드라인에서 설정한 테마와 기존의 테마들을 비교하여 유사도가 0.6이상이고 주식의 상승 이유를 나타내면 해당 테마로 변경 해.\n"
		+ "그렇지 않다면 기존의 테마를 사용해.\n"
