...
public class ThemaPrompt {
	public static final String THEMA_PROMPT =
		"Imagine three different experts are answering this question.\n"
			...
			+ "- Continue to Step 3 with the event name.\n"
			...
			+ "If the event name is not a single word, summarize it into one word.\n"
			+ "- Continue to Step 4 with the specific event name.\n"

			+ "Step 4: **Exclude Stock-Intrinsic Events**\n"
			+ "- If the event is intrinsic to the stock itself (e.g., 'IPO', 'share buyback', or 'price limit reached') never using it.\n"
			...
			+ "- Proceed to Step 5 with the event name.\n"
